...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to frontend configuration retrieval logic should be made in the
...
This repository provides a composite GitHub Action that retrieves frontend
configuration settings from repository-config.yml.
