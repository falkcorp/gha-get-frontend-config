...
- All changes to frontend configuration retrieval logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that retrieves frontend configuration settings from repository-config.yml.
